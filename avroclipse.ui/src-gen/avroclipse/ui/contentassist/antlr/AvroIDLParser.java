...
public class AvroIDLParser extends AbstractContentAssistParser {
	...
	@Override
	protected avroclipse.ui.contentassist.antlr.internal.InternalAvroIDLParser createParser() {
		avroclipse.ui.contentassist.antlr.internal.InternalAvroIDLParser result = new avroclipse.ui.contentassist.antlr.internal.InternalAvroIDLParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAvroIDLFileAccess().getGroup(), "rule__AvroIDLFile__Group__0");
					...
					put(grammarAccess.getAvroIDLFileAccess().getImportsAssignment_0(), "rule__AvroIDLFile__ImportsAssignment_0");
					put(grammarAccess.getAvroIDLFileAccess().getProtocolsAssignment_1(), "rule__AvroIDLFile__ProtocolsAssignment_1");
					...
					put(grammarAccess.getBooleanValueAccess().getValAssignment(), "rule__BooleanValue__ValAssignment");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			avroclipse.ui.contentassist.antlr.internal.InternalAvroIDLParser typedParser = (avroclipse.ui.contentassist.antlr.internal.InternalAvroIDLParser) parser;
			typedParser.entryRuleAvroIDLFile();
