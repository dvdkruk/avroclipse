...
// Entry rule entryRuleAvroIDLFile
entryRuleAvroIDLFile 
:
...
{ before(grammarAccess.getAvroIDLFileAccess().getImportsImportParserRuleCall_0_0()); }
	ruleImport{ after(grammarAccess.getAvroIDLFileAccess().getImportsImportParserRuleCall_0_0()); }
)
...
{ before(grammarAccess.getAvroIDLFileAccess().getProtocolsProtocolParserRuleCall_1_0()); }
	ruleProtocol{ after(grammarAccess.getAvroIDLFileAccess().getProtocolsProtocolParserRuleCall_1_0()); }
)
...
{ before(grammarAccess.getAnnotationAccess().getNameANParserRuleCall_0_0()); }
	ruleAN{ after(grammarAccess.getAnnotationAccess().getNameANParserRuleCall_0_0()); }
)
...
{ before(grammarAccess.getAnnotationAccess().getValuesValuesParserRuleCall_1_1_0()); }
	ruleValues{ after(grammarAccess.getAnnotationAccess().getValuesValuesParserRuleCall_1_1_0()); }
)
...
{ before(grammarAccess.getBooleanValueAccess().getValBooleanParserRuleCall_0()); }
	ruleBoolean{ after(grammarAccess.getBooleanValueAccess().getValBooleanParserRuleCall_0()); }
)
