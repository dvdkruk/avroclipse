...
@Singleton
public class AvdlGrammarAccess extends AbstractGrammarElementFinder {
	
	
	public class AvdlFileElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "AvdlFile");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Assignment cImportsAssignment_0 = (Assignment)cAlternatives.eContents().get(0);
		private final RuleCall cImportsImportParserRuleCall_0_0 = (RuleCall)cImportsAssignment_0.eContents().get(0);
		private final Assignment cProtocolsAssignment_1 = (Assignment)cAlternatives.eContents().get(1);
	...
	public class PrimativeTypeLinkElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cTargetNullKeyword_0_0 = (Keyword)cTargetAlternatives_0.eContents().get(0);
		private final Keyword cTargetIntKeyword_0_1 = (Keyword)cTargetAlternatives_0.eContents().get(1);
		private final Keyword cTargetLongKeyword_0_2 = (Keyword)cTargetAlternatives_0.eContents().get(2);
		private final Keyword cTargetFloatKeyword_0_3 = (Keyword)cTargetAlternatives_0.eContents().get(3);
		private final Keyword cTargetDoubleKeyword_0_4 = (Keyword)cTargetAlternatives_0.eContents().get(4);
		private final Keyword cTargetBytesKeyword_0_5 = (Keyword)cTargetAlternatives_0.eContents().get(5);
		private final Keyword cTargetStringKeyword_0_6 = (Keyword)cTargetAlternatives_0.eContents().get(6);
		...
		//"null"
		public Keyword getTargetNullKeyword_0_0() { return cTargetNullKeyword_0_0; }

		//"int"
		public Keyword getTargetIntKeyword_0_1() { return cTargetIntKeyword_0_1; }

		//"long"
		public Keyword getTargetLongKeyword_0_2() { return cTargetLongKeyword_0_2; }

		//"float"
		public Keyword getTargetFloatKeyword_0_3() { return cTargetFloatKeyword_0_3; }

		//"double"
		public Keyword getTargetDoubleKeyword_0_4() { return cTargetDoubleKeyword_0_4; }

		//"bytes"
		public Keyword getTargetBytesKeyword_0_5() { return cTargetBytesKeyword_0_5; }

		//"string"
		public Keyword getTargetStringKeyword_0_6() { return cTargetStringKeyword_0_6; }
	}
	...
	private final AvdlFileElements pAvdlFile;
	...
	@Inject
	public AvdlGrammarAccess(GrammarProvider grammarProvider,
		TerminalsGrammarAccess gaTerminals) {
		this.grammar = internalFindGrammar(grammarProvider);
		this.gaTerminals = gaTerminals;
		this.pAvdlFile = new AvdlFileElements();
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("avroclipse.Avdl".equals(grammar.getName())) {
				return grammar;
			}
	...
	//AvdlFile:
	//	(imports+=Import | protocols+=Protocol)*;
	public AvdlFileElements getAvdlFileAccess() {
		return pAvdlFile;
	}
	
	public ParserRule getAvdlFileRule() {
		return getAvdlFileAccess().getRule();
	}
