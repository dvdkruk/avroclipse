...
entryRuleAvroIDLFile returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getAvroIDLFileRule()); }
	 iv_ruleAvroIDLFile=ruleAvroIDLFile 
	 { $current=$iv_ruleAvroIDLFile.current; } 
	 EOF 
;

// Rule AvroIDLFile
ruleAvroIDLFile returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
