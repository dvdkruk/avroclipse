...
public class AvdlSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        AvdlFile avdlFile = (AvdlFile)theEObject;
        T result = caseAvdlFile(avdlFile);
      ...
      case AvdlPackage.RETURN_TYPE_LINK:
      {
   ...
   * @generated
   */
  public T caseAvdlFile(AvdlFile object)
  {
    return null;
  }
