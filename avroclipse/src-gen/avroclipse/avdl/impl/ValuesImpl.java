 ...
 * </p>
 * <ul>
 *   <li>{@link avroclipse.avdl.impl.ValuesImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValuesImpl extends MinimalEObjectImpl.Container implements Values
{
  ...
  {
    return AvdlPackage.Literals.VALUES;
  }
  ...
  public EList<Value> getValue()
  {
    if (value == null)
    {
      value = new EObjectContainmentEList<Value>(Value.class, this, AvdlPackage.VALUES__VALUE);
    }
    return value;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AvdlPackage.VALUES__VALUE:
