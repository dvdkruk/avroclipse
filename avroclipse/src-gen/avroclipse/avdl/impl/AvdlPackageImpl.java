...
import avroclipse.avdl.AvdlFactory;
 ...
 * @generated
 */
public class AvdlPackageImpl extends EPackageImpl implements AvdlPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  private EClass avdlFileEClass = null;
   ...
   * @see avroclipse.avdl.AvdlPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private AvdlPackageImpl()
  {
    super(eNS_URI, AvdlFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link AvdlPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static AvdlPackage init()
  {
    if (isInited) return (AvdlPackage)EPackage.Registry.INSTANCE.getEPackage(AvdlPackage.eNS_URI);

    // Obtain or create and register package
    AvdlPackageImpl theAvdlPackage = (AvdlPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof AvdlPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new AvdlPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theAvdlPackage.createPackageContents();

    // Initialize created meta-data
    theAvdlPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theAvdlPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(AvdlPackage.eNS_URI, theAvdlPackage);
    return theAvdlPackage;
  }
   ...
   * @generated
   */
  public EClass getAvdlFile()
  {
    return avdlFileEClass;
  }
   ...
   * @generated
   */
  public EReference getAvdlFile_Imports()
  {
    return (EReference)avdlFileEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getAvdlFile_Protocols()
  {
    return (EReference)avdlFileEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public AvdlFactory getAvdlFactory()
  {
    return (AvdlFactory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    avdlFileEClass = createEClass(AVDL_FILE);
    createEReference(avdlFileEClass, AVDL_FILE__IMPORTS);
    createEReference(avdlFileEClass, AVDL_FILE__PROTOCOLS);
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(avdlFileEClass, AvdlFile.class, "AvdlFile", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getAvdlFile_Imports(), this.getImport(), null, "imports", null, 0, -1, AvdlFile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getAvdlFile_Protocols(), this.getProtocol(), null, "protocols", null, 0, -1, AvdlFile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
