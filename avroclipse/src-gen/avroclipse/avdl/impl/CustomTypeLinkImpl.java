 ...
 * </p>
 * <ul>
 *   <li>{@link avroclipse.avdl.impl.CustomTypeLinkImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CustomTypeLinkImpl extends TypeLinkImpl implements CustomTypeLink
{
  ...
  {
    return AvdlPackage.Literals.CUSTOM_TYPE_LINK;
  }
    ...
    if (target != null && target.eIsProxy())
    {
      ...
      if (target != oldTarget)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, AvdlPackage.CUSTOM_TYPE_LINK__TARGET, oldTarget, target));
      }
    }
    return target;
  }
  ...
  public void setTarget(Type newTarget)
  {
    ...
    target = newTarget;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AvdlPackage.CUSTOM_TYPE_LINK__TARGET, oldTarget, target));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AvdlPackage.CUSTOM_TYPE_LINK__TARGET:
