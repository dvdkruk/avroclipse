 ...
 * </p>
 * <ul>
 *   <li>{@link avroclipse.avroIDL.impl.EnumTypeImpl#getLiterals <em>Literals</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumTypeImpl extends TypeImpl implements EnumType
{
  ...
  {
    return AvroIDLPackage.Literals.ENUM_TYPE;
  }
  ...
  public EList<String> getLiterals()
  {
    if (literals == null)
    {
      literals = new EDataTypeEList<String>(String.class, this, AvroIDLPackage.ENUM_TYPE__LITERALS);
    }
    return literals;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AvroIDLPackage.ENUM_TYPE__LITERALS:
        return getLiterals();
    }
