 ...
 * </p>
 * <ul>
 *   <li>{@link avroclipse.avroIDL.impl.ValuesImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValuesImpl extends MinimalEObjectImpl.Container implements Values
{
  ...
  {
    return AvroIDLPackage.Literals.VALUES;
  }
  ...
  public EList<Value> getValue()
  {
    if (value == null)
    {
      value = new EObjectContainmentEList<Value>(Value.class, this, AvroIDLPackage.VALUES__VALUE);
    }
    return value;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AvroIDLPackage.VALUES__VALUE:
