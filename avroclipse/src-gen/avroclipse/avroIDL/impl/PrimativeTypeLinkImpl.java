 ...
 * </p>
 * <ul>
 *   <li>{@link avroclipse.avroIDL.impl.PrimativeTypeLinkImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimativeTypeLinkImpl extends TypeLinkImpl implements PrimativeTypeLink
{
  ...
  {
    return AvroIDLPackage.Literals.PRIMATIVE_TYPE_LINK;
  }
  ...
  public void setTarget(String newTarget)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AvroIDLPackage.PRIMATIVE_TYPE_LINK__TARGET, oldTarget, target));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AvroIDLPackage.PRIMATIVE_TYPE_LINK__TARGET:
        return getTarget();
    }
